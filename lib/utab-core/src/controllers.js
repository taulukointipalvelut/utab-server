...
class CON {
    constructor(db_url, options) {
        ...
        this.teams = {
            ...
            results: {
                summarize: con.dbh.raw_team_results.summarize.bind(con.dbh.raw_team_results),
        ...
        this.adjudicators = {
            ...
            results: {
                summarize: con.dbh.raw_adjudicator_results.summarize.bind(con.dbh.raw_adjudicator_results),
        ...
        this.speakers = {
            ...
            results: {
                summarize: con.dbh.raw_speaker_results.summarize.bind(con.dbh.raw_speaker_results),
        ...
        this.destroy = con.dbh.destroy.bind(con.dbh)
    }
}
