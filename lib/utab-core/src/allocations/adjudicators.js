...
function get_adjudicator_ranks (r, allocation, teams, adjudicators, compiled_adjudicator_results, filter_functions1, filter_functions2, config) {
    ...
    for (var square of allocation_cp) {
        adjudicators.sort(sortings.sort_decorator(square, filter_functions1, {teams: teams, compiled_adjudicator_results: compiled_adjudicator_results, config: config, r: r}))
...
function get_adjudicator_draw (r, draw, adjudicators, teams, compiled_team_results, compiled_adjudicator_results, {chairs: chairs, panels: panels, trainees: trainees}, config, {filters: filters=['by_bubble', 'by_strength', 'by_num', 'by_num_chair', 'by_conflict', 'by_institution', 'by_past']}) {//GS ALGORITHM BASED//
